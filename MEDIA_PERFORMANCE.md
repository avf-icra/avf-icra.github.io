...
```sh
npm install --prefix /tmp/media-tests playwright
NODE_PATH=/tmp/media-tests/node_modules node scripts/test_media.cjs
NODE_PATH=/tmp/media-tests/node_modules node scripts/test_fixation_actions.cjs
```
