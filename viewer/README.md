...
```
index.html, app.js, style.css   frontend (relative paths only)
...
avf/peripheral/mono policies, so unused clips are never shipped.
...
For a true subdomain like `avf-viewer.github.io` (free), create a GitHub
